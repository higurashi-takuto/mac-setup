...
curl -L https://raw.githubusercontent.com/higurashi-takuto/mac-setup/master/sublime/OmniMarkupPreviewer.sublime-settings > ~/Library/Application\ Support/Sublime\ Text\ 3/Packages/User/OmniMarkupPreviewer.sublime-settings
