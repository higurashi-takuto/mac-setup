...
curl -L https://raw.githubusercontent.com/higurashi-takuto/mac-setup/master/Default.sublime-keymap > ~/Library/Application\ Support/Sublime\ Merge/Packages/UserDefault.sublime-keymap
